/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/data-pipeline/wrangler.jsonc cloudflare/data-pipeline/worker-configuration.d.ts` (hash: 63014e96d1953aa661207e98b1b5d2af)
// Runtime types generated with workerd@1.20260828.1 2026-08-31 nodejs_compat
interface __BaseEnv_Env {
	DATA_ARTIFACTS: R2Bucket;
	CDSAPI_KEY: string;
	INGEST_ADMIN_TOKEN: string;
	DATA_PIPELINE: DurableObjectNamespace<import("./worker").DataPipelineContainer>;
	INGEST_WORKFLOW: Workflow<Parameters<import("./worker").RealDataIngestWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "DataPipelineContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CDSAPI_KEY" | "INGEST_ADMIN_TOKEN">> {}
}
