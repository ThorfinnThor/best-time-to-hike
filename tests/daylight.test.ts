...
import { daylight, daylightForLocalDate, expectedHourlyInstants, inHikingWindow } from "../lib/hiking/daylight";
...
test("historical two-hour IANA clock changes retain their actual local-day length",()=>{assert.equal(expectedHourlyInstants("1992-10-18","America/Argentina/Mendoza"),22)});
