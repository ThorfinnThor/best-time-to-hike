...
export const getManifest = () => read<{datasetStatus:"fixture"|"provisional"|"production";datasetVersion:string;algorithmVersion:string;generatedAt:string;destinationCount:number;climateNormal:{startYear:number;endYear:number}}>("manifest.json");
