...
/** Verified local sources are optional; they do not control access to the planning UI. */
export const hikingSources: Partial<Record<string, { url: string; source: string }>> = {
